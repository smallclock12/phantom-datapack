...
summon minecraft:phantom ~ ~10 ~ {equipment:{head:{id:"minecraft:netherite_helmet"}},PersistenceRequired:true,ArmorItems:[{id:"netherite_helmet"},{id:"netherite_chestplate", components:{"minecraft:enchantments": {projectile_protection:5}}},{},{}],attributes:[{id:"minecraft:burning_time",base:0},{id:"minecraft:max_health",base:460}],Size:24,Health:460,Tags:["terror","boss"]}
