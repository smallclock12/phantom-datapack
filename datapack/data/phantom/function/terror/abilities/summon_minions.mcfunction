...
execute unless score terror/ability_telegraph Phantom <= terror/ability_counter Phantom run return fail

# place our markers
execute if score terror/ability_telegraph Phantom = terror/ability_counter Phantom at @a[distance=..50,gamemode=survival] run summon minecraft:marker ~ ~ ~ {Tags:["terror_attack_summon_minion"]}
